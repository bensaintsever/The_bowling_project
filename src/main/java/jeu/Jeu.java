...
public class Jeu {
    ...
    public final void jouer(final int coup1, final int coup2, final int coup3)
        ...
        if (coup3 < 0 || coup3 > NOMBRE_QUILLE_DEPART) {
        ...
        if (this.coup1 == Coup.STRIKE) {
            ...
            lancerCoup3(coup3);
            if (this.coup2 != Coup.STRIKE) {
                if ((coup2 + coup3) > NOMBRE_QUILLE_DEPART) {
            ...
            if ((coup1 + coup2) > NOMBRE_QUILLE_DEPART) {
    ...
    private void lancerCoup2(int coup2) {
        try {
            int nombreQuilleRestanteCoup1 = NOMBRE_QUILLE_DEPART - this
                    .nombreQuilleTombe;
    ...
    private void lancerCoup3(int coup3) {
        try {
            int nombreQuilleRestanteCoupPrecedent = NOMBRE_QUILLE_DEPART - this
                    .nombreQuilleTombe;
