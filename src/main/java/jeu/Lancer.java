...
public class Lancer
{
     ...
     *
     * ATTENTION : nombreQuilleDepart doit être supérieur ou égale à nombreQuilleTombe
     ...
     */
    public Lancer(int nombreQuilleDepart, int nombreQuilleTombe) throws Exception {
        if (nombreQuilleDepart < nombreQuilleTombe )
            throw new Exception("Le nombre de quille debout doit être supérieur ou égale au nombre de quilles tombés");
        if (nombreQuilleDepart <= 0)
            throw new Exception ("Le nombre de quille debout doit être supérieur ou égale à 0");
